...
public class MagazineDAO {
    ...
    public void save(Magazine magazine) {
        ...
        try {
            ...
            em.persist(magazine);
            transaction.commit();
            System.out.println("Magazine salvato correttamente: " + magazine);
        } catch (Exception e) {
    ...
    public void delete(long id ) {
        ...
        if (magazine != null) {
            ...
            try {
                ...
                em.remove(magazine);
                transaction.commit();
                System.out.println("Magazine eliminato correttamente: " + magazine);
            } catch (Exception e) {
                if (transaction.isActive()) {
                    transaction.rollback();
                }
                System.err.println("Errore durante l'eliminazione del magazine." + e);
                throw e;
            }
        }
    }
